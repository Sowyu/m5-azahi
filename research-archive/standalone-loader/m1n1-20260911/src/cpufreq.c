...
/*
 * T6050 (M5 Pro): 2x 6-core M clusters + 1x 6-core P cluster.
 * Bases derived from the ADT (/cpus/cpuN cpm-impl-reg & ~0xfffff) on a
 * MacBook Pro 14" M5 Pro (j714s):
 *   cluster0 type=M cpm-impl=0x210e40000
 *   cluster1 type=M cpm-impl=0x211e40000
 *   cluster2 type=P cpm-impl=0x212e40000
 * The kernel expects the E-core-equivalent clusters named ECPUn.
 */
static const struct cluster_t t6050_clusters[] = {
    {"ECPU0", 0x210e00000, false, 1, 5},
    {"ECPU1", 0x211e00000, false, 1, 5},
    {"PCPU0", 0x212e00000, true, 1, 6},
    {},
};
