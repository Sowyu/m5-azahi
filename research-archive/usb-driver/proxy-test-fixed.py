#!/usr/bin/env python3
"""One-shot RAM-only correction/test of the observed v4 fallback session.
...
FUNCTION_SIZE = 0x80c
NEXT_STAGE = 0xdf5d0
FIXED_SHA = '2af8a24f94756f38ef7dfe6056c4e6c43d9df4ede993ddcc718932160dc26b75'
PORT = '/dev/cu.usbmodemPRIVATE-SERIAL-REMOVED'
...
def main():
    ...
    try:
        ...
        assert revision == 3 and ba_address == 0x1000a960000
