...
```
+++ /private/tmp/claude-<UID>/-Users-PRIVATE-USER-<four private folder names>/PRIVATE-UUID-REMOVED/scratchpad/m1n1-fix/src/hv_exc.c	<timestamp>
```
...
this string is `-Users-PRIVATE-USER-...` because macOS had already flattened the
